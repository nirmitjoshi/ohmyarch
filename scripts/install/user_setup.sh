...
sudo pacman -S --noconfirm --needed helix obsidian syncthing npm grim slurp mpv ripgrep rustup tree polkit-kde-agent kdeconnect wl-clipboard github-cli qt5-wayland qt6-wayland unzip openssh tailscale docker man-db
