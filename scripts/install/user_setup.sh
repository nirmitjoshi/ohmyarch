...
sudo pacman -S --noconfirm --needed firefox neovim obsidian syncthing npm discord grim slurp vlc polkit-kde-agent kdeconnect wl-clipboard github-cli qt5-wayland qt6-wayland
